...
# 10 passed; missing/sentinel NEXT_PUBLIC_NAVER_MAPS_CLIENT_ID, missing production
# NEXT_PUBLIC_API_BASE_URL, missing production NEXT_PUBLIC_PLATFORM_CORE_BASE_URL,
# unsafe production INTERNAL_AUTH_SECRET, and production SESSION_SECRET sentinels are rejected
...
pnpm --filter @gongzzang/web test
# 35 test files passed, 144 tests passed, 1 skipped
