...
> Current status (2026-05-28): Historical for Gongzzang runtime scope.
> Data-pipeline orchestration moved to Platform Core under ADR 0034. Do not
> recreate `pipeline_run`/`pipeline_schedule` product UI in Gongzzang without a
> new ADR that changes ownership.
