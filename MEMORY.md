...
- [프로젝트 진행 현황](memory/project_progress.md) — SP1+2+3+5-i+5-iii+5-iv+4-i+5-ii+4-ii 완료 (29 crate, ~1195 tests), V-World 통합 + Circuit Breaker 도입, MSVC Build Tools 설치됨, 3 CI workflow 그린
